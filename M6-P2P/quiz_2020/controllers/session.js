...
exports.adminRequired = (req, res, next) => {
  ...
  if (isAdmin) {
    ...
    console.log(
      "Prohibited route: the logged in user is not an administrator."
    );
    res.sendStatus(403);
  }
};
...
exports.adminOrMyselfRequired = (req, res, next) => {
  ...
  if (isAdmin || isMyself) {
    ...
    console.log(
      "Prohibited route: it is not the logged in user, nor an administrator."
    );
    res.send(403);
  }
};
...
exports.authGitHub =
  GitHubStrategy && passport.authenticate("github", { scope: ["user"] });
...
exports.authGoogle =
  GoogleStrategy && passport.authenticate("google", { scope: ["profile"] });

// GET /auth/google/callback
exports.authGoogleCB =
  GoogleStrategy &&
